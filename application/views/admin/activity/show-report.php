        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h1 class="box-title pullLeft"><b><?php echo $this->lang->line('PRODUCTS_LISTING_LABEL'); ?></b></h1>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <label for="Total Buy"><?= $this->lang->line('TOTAL_BUY');?></label>
                        <div class="form-group">
                            <input type="text" class="form-control" name="totalBuy" value="<?php echo $adminReport['buy_total']; ?>" readonly=""/>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label for="Total Buy"><?= $this->lang->line('TOTAL_SELL');?></label>
                        <div class="form-group">
                            <input type="text" class="form-control" value="<?php echo $adminReport['sell_total']; ?>" name="totalBuy" readonly=""/>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label for="Total Buy"><?= $this->lang->line('PROFIT');?></label>
                        <div class="form-group">
                            <input type="text" class="form-control" value="<?php echo $adminReport['sell_total'] - $adminReport['buy_total'] ?>" name="totalBuy" readonly=""/>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            foreach($productlist as $sl) {  ?>
                                <tr>
                                    ...
                                    <td >
                                        <div data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('SKU_LABEL'); ?>"><a href="<?php echo base_url('admin/products/edit/'.$sl->user_id.'/'.$sl->id); ?>"><?= $sl->sku; ?></a></div></td>
                                    <!-- <td><?= $sl->name; ?></td> -->
                                    <td><?= $sl->fullname ?></td>
...
<script type="text/javascript">
    ...
    function showAddProduct(id)
    {
        if(id!='') {
           $("#addButtonDiv").show();
            var link = $base_url+'admin/products/add/'+id;
