            ...
            <div class="box">
                <div class="box-header">
                        <div class="search-group" id="addButtonDiv" style="float:right;">
                            <a href="<?= base_url('admin/selling-to-customer/add') ?>">
                    ...
                    <table id="productTable" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $this->lang->line('TOTAL_AMOUNT_USD'); ?></th>
                                <th><?php echo $this->lang->line('TOTAL_AMOUNT_ISR'); ?></th>
                        ...
                        <tbody>
                            ...
                            foreach($productlist as $sl) {  ?>
                                <tr>
                                    ...
                                    <!-- <td><?= $sl->name; ?></td> -->
                                    <td><?= $sl['firstname'] ?></td>
                                    <td><?= $sl['final_total_usd'] ?></td>
                                    <td><?= $sl['final_total_isr'] ?></td>
                                    <td><?= $sl['net_quantity'] ?></td>
                                    <td><?= $sl['created_at'] ?></td>
